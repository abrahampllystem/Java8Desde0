package pe.tcs.java8.highorder;
...
public class HighApp {
	...
	public static void main(String[] args) {
		...
		app.imprimir(app.convertirMayusculas, "martin");
		app.imprimir(app.convertirMinusculas, "MARTIN");
		
		String rpta = app.mostrar("Hola ").apply("MartinVera");
